...
SimpleForm.setup do |config|
  ...
  config.button_class = 'px-5 py-1 text-white transition-colors duration-150 bg-gray-800 rounded-lg focus:shadow-outline hover:bg-white hover:text-black border-black border'
